        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="cyan"> C++ and Debugging code. </b>
              </i>
              <br />
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/atultechd"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/Atultechd"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/atultechd/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/a.t.e.c.h.d/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
